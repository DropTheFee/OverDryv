...
-- =====================================================
-- Note: estimate_number will be auto-generated by trigger
INSERT INTO estimates (estimate_number, customer_id, vehicle_id, status, service_type, description, total_amount, priority, notes, valid_until)
SELECT 
  NULL,
  p.id, 
  v.id, 
